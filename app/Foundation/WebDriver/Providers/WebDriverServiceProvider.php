...
use BIRD3\Foundation\WebDriver\ResponseFactory;

/*
    This is a full copy of the original RoutingServiceProvider.
    This one has been advanced to adhere to WebDriver.

    To use it, you need to extend Laravel's Application class and
    register this provider instead of the default RoutingServiceProvider.
*/
