...
class Browser
{
    ...
    const BROWSER_IPHONE = 'Mobile Safari'; // http://apple.com
    const BROWSER_IPOD = 'Mobile Safari'; // http://apple.com
    const BROWSER_IPAD = 'Mobile Safari'; // http://apple.com
    ...
    const PLATFORM_APPLE = 'OS X';
    const PLATFORM_LINUX = 'GNU/Linux';
    const PLATFORM_OS2 = 'OS/2';
    const PLATFORM_BEOS = 'BeOS';
    const PLATFORM_IPHONE = 'iOS (iPhone)';
    const PLATFORM_IPOD = 'iOS (iPod)';
    const PLATFORM_IPAD = 'iOS (iPad)';
