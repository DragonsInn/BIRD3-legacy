var router = require("router")(),
    ...
    pOpt = {
        ...
        port: config.BIRD3.app_port // The dragon's inn port. wut!
    },
...
module.exports = function(http) {
    ...
    portscanner.checkPortStatus(config.BIRD3.app_port, config.BIRD3.host, function(err, status){
        if(status=="closed") {
            ...
            router.all("*", function(req, res){
                ...
                req.headers["BIRD3_VERSION"] = config.BIRD3.version;
