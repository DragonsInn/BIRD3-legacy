...
class Browser extends CApplicationComponent
{
    ...
    const BROWSER_IPHONE = 'Mobile Safari (iPhone)'; // http://apple.com
    const BROWSER_IPOD = 'Mobile Safari (iPod)'; // http://apple.com
    const BROWSER_IPAD = 'Mobile Safari (iPad)'; // http://apple.com
    const BROWSER_CHROME = 'Google Chrome'; // http://www.google.com/chrome
    const BROWSER_ANDROID = 'Google Android'; // http://www.android.com/
    ...
    const PLATFORM_IPHONE = 'Apple iOS (iPhone)';
    const PLATFORM_IPOD = 'Apple iOS (iPod)';
    const PLATFORM_IPAD = 'Apple iOS (iPad)';
